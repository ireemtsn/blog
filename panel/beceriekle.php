...
<body>
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Beceri Ekleme Alanı</h4>
            ...
            <form style="width:500px;margin-left:200px;" action="">
            <div class="container">
   <div class="row">
      <div class="col-lg-12">
      ...
      <div class="col-lg-12">
         <input type="text" class="form-control" style="margin-top:20px;"  placeholder="soyad" id="exampleInputEmail1" aria-describedby="emailHelp">
      </div>
   </div>
  ...
  <option selected>Beceri Seç</option>
  ...
  <option value="6">phyton</option>
   ...
   <center>
   <a href="beceri.php" type="button" style="width:150px;"  class="btn btn-outline-success my-3">Ekle</a>
   </center>
