<?php
   ...
   session_start();
     if (isset($_SESSION['oturum'])) {
       ...
       $sorgu = $baglanti->prepare("SELECT * FROM kartlar");
       ...
       $sonuc = $sorgu->fetchAll();//sorgu çalıştırılıp veriler alınıyor
          ...
          if ($_POST) { // Post olup olmadığını kontrol ediyoruz.
               ...
               if ($aciklama <> "" && $metin <> ""  && $hata == "") { // Veri alanlarının boş olmadığını kontrol ettiriyoruz.
                   //Değişecek veriler
                   $satir = [
                    'aciklama' => $aciklama,
                    'metin' => $metin,
                ...
                $ata = "UPDATE formalani SET  aciklama=:aciklama, metin=:metin WHERE id=1";             
      ...
      <div id="main-wrapper">
         ...
         <div class="page-wrapper">
            <div class="page-breadcrumb">
               <div class="row">
                  <div class="col-12 d-flex no-block align-items-center">
                     <h4 class="page-title"> KARTLAR</h4>
            ...
            <div class="container">
               <div class="row">
                  ...
                  <div class="col-lg-4">
                     <div class="card" style="width: 18rem;">
                        <div class="card-body">
                           <h5><?=$row['aciklama']?></h5>
                           <p class="card-text"><?=$row['metin']?></p>
                        </div>
                     </div>
                     <div class="btn-group" role="group" aria-label="Basic outlined example">
                        <a href="kartlardüzenle.php?id=<?=$row["id"];?>"  type="button" class="btn btn-outline-primary">Güncelle</a>
                        <a href="kartsil.php?id=<?=$row['id']?>" type="button" class="btn btn-outline-success">Sil</a>
                     </div>
                  </div>
                  <?php } ?>  
               ...
               <a href="kartlarekle.php" type="button"  class="btn btn-outline-warning my-3">Ekle</a>
