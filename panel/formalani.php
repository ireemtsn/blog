<?php
   ...
   session_start();
     if (isset($_SESSION['oturum'])) {
       ...
       $sorgu = $baglanti->prepare("SELECT * FROM formalani");
       ...
       $sonuc = $sorgu->fetch();//sorgu çalıştırılıp veriler alınıyor
          ...
          if ($_POST) { // Post olup olmadığını kontrol ediyoruz.
               ...
               if ($ad <> "" && $soyad <> "" && $mail <> "" && $hata == "") { // Veri alanlarının boş olmadığını kontrol ettiriyoruz.
                   //Değişecek veriler
                   $satir = [
                    'ad' => $ad,
                    'soyad' => $soyad,
                ...
                $ata = "UPDATE formalani SET  ad=:ad, soyad=:soyad,mail=:mail WHERE id=1";             
...
<html dir="ltr" lang="en">
      ...
      <div class="page-breadcrumb">
         <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
               <h4 class="page-title">Form Alanı</h4>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
        <a href="formalanigüncelle.php?id=<?=$row['id']?>"  label class="btn btn-outline-success" for="btncheck2">Güncelle</a>
        <a href="kartsil.php?id=<?=$row['id']?>"       label class="btn btn-outline-success" for="btncheck3">Sil</>
        </div></td>
    </tr>
    <?php } ?>
 ...
 <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
  ...
  <a href="formalaniekle.php" label style="margin-left:30px;" class="btn btn-outline-success" for="btncheck1">Ekle</a>
