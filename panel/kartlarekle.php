  ...
  if (isset($_SESSION['oturum'])) {         // BUNA COK GEREK YOK 
      ...
      header("Location:giris.php");
          ...
          if ($_POST) { // Post olup olmadığını kontrol ediyoruz.
                  $aciklama = $_POST['aciklama']; // Sayfa yenilendikten sonra post edilen değerleri değişkenlere atıyoruz
                  $metin = $_POST['metin'];
                  $hata = '';
               ...
               if ($aciklama <> "" && $hata == "") { // Veri alanlarının boş olmadığını kontrol ettiriyoruz.
                   //Değişecek veriler
                   $satir = [
                ...
                $sql = "INSERT INTO kartlar SET aciklama=:aciklama ,metin=:metin";             
   ...
   <div class="col-md-6">
      <div class="card">
         <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
            <div class="card-body">
               <center>
                  <h4 class="card-title">Kart Ekleme</h4>
               </center>
               <div class="form-group row" style="text-align:left">
                  <label  for="fname" class="col-sm-3 text-right control-label col-form-label">Açıklama</label>
                  <div class="col-sm-9">
                     <input name="aciklama" type="text" class="form-control"  placeholder="">
                  </div>
               </div>
               <div class="form-group row">
                  <label  for="fname" class="col-sm-3 text-right control-label col-form-label">Metin </label>
                  <div class="col-sm-9">
                     <input name="metin" type="text" class="form-control"  placeholder="">
                  </div>
               </div>
            </div>
            <center>
               <div class="border-top">
                  <div class="card-body">
                     <button style="width:150px;" type="submit" class="btn btn-primary">Ekle</button>
                  </div>
               </div>
            </center>
         </form>
