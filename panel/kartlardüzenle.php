...
session_start();        // admin panelinde giriş yapmadan girmemek için yazılan kod  
  if (isset($_SESSION['oturum'])) {         // BUNA COK GEREK YOK 
   ...
   $sorgu = $baglanti->prepare("SELECT * FROM kartlar Where id=:id");
   ...
   $sonuc = $sorgu->fetch();//sorgu çalıştırılıp veriler alınıyor
          ...
          if ($_POST) { // Post olup olmadığını kontrol ediyoruz.
               ...
               if ($aciklama <> "" && $hata == "") { // Veri alanlarının boş olmadığını kontrol ettiriyoruz.
                ...
                $sql = "UPDATE kartlar SET aciklama=:aciklama, metin=:metin WHERE id=:id;";             
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Kart Güncelleme</h4>
            ...
            <div class="col-md-7 d-print-none "  >
                ...
                <div class="my-4">
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-4">
                            <label for="exampleFormControlInput1">Aciklama</label>
                                <input class="form-control" cols="40" rows="5" value="<?=$sonuc["aciklama"];?>" type="text" name="aciklama" placeholder="" required>
                            </div>
                            <div class="col-4">
                            <label for="exampleFormControlInput1">Metin</label>
                                <input class="form-control" type="text"  value="<?=$sonuc["metin"];?>" name="metin" placeholder="" required>
                        </div>
