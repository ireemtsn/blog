...
session_start();        // admin panelinde giriş yapmadan girmemek için yazılan kod  
  if (isset($_SESSION['oturum'])) {         // BUNA COK GEREK YOK 
      ...
      header("Location:giris.php");
          ...
          if ($_POST) { // Post olup olmadığını kontrol ediyoruz.
               ...
               if ($hata == "") { // Veri alanlarının boş olmadığını kontrol ettiriyoruz.
                ...
                $sql = "INSERT INTO sayfam SET foto=:foto, metin=:metin";             
   ...
   // -----------------------------------------------------
    ...
    $sorgu = $baglanti->query("SELECT * FROM sayfam ORDER BY id DESC LIMIT 12")->fetchAll(PDO::FETCH_ASSOC);
...
.lightbox-gallery .item {
  ...
  <label for="floatingTextarea">Blog metninizi giriniz.</label>
</div>
                <!--  <div class="form-group mt-3">
                        <label class="mb-3" for="exampleFormControlFile1">Metin</label><br>
                        <input type="text" name="metin" class="form-control-file mb-3">
               </div> -->
                     <div class="form-group mt-3">
