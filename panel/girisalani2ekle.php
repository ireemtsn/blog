      ...
      header("Location:giris.php");
          ...
          if ($_POST) { // Post olup olmadığını kontrol ediyoruz.
               ...
               if ($yazi1 <> "" && $hata == "") { // Veri alanlarının boş olmadığını kontrol ettiriyoruz.
                ...
                $sql = "INSERT INTO girisalani2 SET foto=:foto, yazi1=:yazi1,yazi2=:yazi2";             
                            ...
                            <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row" style="text-align:left">
                                        <label  for="fname" class="col-sm-3 text-right control-label col-form-label">Yazi1</label>
                                        <div class="col-sm-9">
                                            <input name="yazi1" type="text" class="form-control"  placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label  for="fname" class="col-sm-3 text-right control-label col-form-label">Yazi2 </label>
                                        <div class="col-sm-9">
                                            <input name="yazi2" type="text" class="form-control"  placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
