  ...
  if (isset($_SESSION['oturum'])) {         // BUNA COK GEREK YOK 
      ...
      header("Location:giris.php");
          ...
          if ($_POST) { // Post olup olmadığını kontrol ediyoruz.
               ...
               if ($ad <> "" && $hata == "") { // Veri alanlarının boş olmadığını kontrol ettiriyoruz.
                   //Değişecek veriler
                   $satir = [
                ...
                $sql = "INSERT INTO formalani SET foto=:foto, ad=:ad ,soyad=:soyad ,mail=:mail";             
   ...
   <div class="col-md-6">
      <div class="card">
         <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
            <div class="card-body">
               <center>
                  <h4 class="card-title">Giriş Alanı2 Ekleme</h4>
               </center>
               <div class="form-group row" style="text-align:left">
                  <label  for="fname" class="col-sm-3 text-right control-label col-form-label">Ad</label>
                  <div class="col-sm-9">
                     <input name="ad" type="text" class="form-control"  placeholder="">
                  </div>
               </div>
               <div class="form-group row">
                  <label  for="fname" class="col-sm-3 text-right control-label col-form-label">Soyad </label>
                  <div class="col-sm-9">
                     <input name="soyad" type="text" class="form-control"  placeholder="">
                  </div>
               </div>
               <div class="form-group row">
                  <label  for="fname" class="col-sm-3 text-right control-label col-form-label">Mail</label>
                  <div class="col-sm-9">
                     <input name="mail" type="" class="form-control"  placeholder="">
                  </div>
               </div>
               <div class="form-group row">
