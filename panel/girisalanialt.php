...
<body>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="widgets.html" aria-expanded="false"><i class="mdi mdi-chart-bubble"></i><span class="hide-menu">Giriş Alanı Alt</span></a></li>
 ...
 ?>
    ...
    <tr>
      ...
      <td><?= $row["yazi2"];?></td>
      <td><?= $row["foto"];?></td>
      <td><a href="girisalani2duzenle.php?id=<?= $row["id"];?>" class="btn btn-light">Düzenle </a></td>
      <td><a href="girisalani2sil.php?id=<?= $row["id"];?>" class="btn btn-light">Sil </a></td>
...
<center>
 <a href="girisalani2ekle.php" style="width: 150px;" type="button" class="btn btn-success">Ekle </a>
</center>
