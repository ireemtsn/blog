...
session_start();        // admin panelinde giriş yapmadan girmemek için yazılan kod  
  if (isset($_SESSION['oturum'])) {         // BUNA COK GEREK YOK 
   ...
   $sorgu = $baglanti->prepare("SELECT * FROM formalani Where id=:id");
   ...
   $sonuc = $sorgu->fetch();//sorgu çalıştırılıp veriler alınıyor
          ...
          if ($_POST) { // Post olup olmadığını kontrol ediyoruz.
               ...
               if ($ad <> "" && $hata == "") { // Veri alanlarının boş olmadığını kontrol ettiriyoruz.
                ...
                $sql = "UPDATE formalani SET foto=:foto, ad=:ad,soyad=:soyad,mail=:mail WHERE id=:id;";             
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <label for="exampleFormControlInput1">Ad</label>
                                <input class="form-control" cols="40" rows="5" value="<?=$sonuc["ad"];?>" type="text" name="ad" placeholder="" required>
                            </div>
                            <div class="col-4">
                            <label for="exampleFormControlInput1">Soyad</label>
                                <input class="form-control" type="text"  value="<?=$sonuc["soyad"];?>" name="soyad" placeholder="" required>
                        </div>
                        <div class="col-4">
                            <label for="exampleFormControlInput1">Mail</label>
                                <input class="form-control" cols="40" rows="5" value="<?=$sonuc["mail"];?>" type="text" name="mail" placeholder="" required>
                            </div>
                    </div>
